...
function Badge({ children, className = "" }) {
  return (
    <span
      className={`inline-flex items-center leading-none font-semibold px-[5px] py-[1px] rounded-full text-[10px] tracking-[0.02em] ${className}`}
    >
      {children}
    </span>
  );
...
export default function IssueCard({ issue, onTriageClick }) {
  ...
  return (
    <div
      className={`group relative rounded-xl px-[18px] py-[13px] cursor-default transition-colors duration-150
    ...
    >
      ...
      <div className="relative">
        {/* Meta row */}
        <div className="flex items-center gap-[3px] mb-[3px] flex-wrap">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            {issue.body && (
              <p className="mt-[2px] text-[12.5px] text-ink-subtle leading-[1.5] line-clamp-2">
                {issue.body}
              </p>
            )}
          </div>
          ...
          <span
            className={`shrink-0 inline-flex items-center px-[6px] py-[2px] rounded-full text-[10px] font-semibold tracking-[0.02em] leading-none
        ...
        {/* Actions */}
        <div className="flex items-center gap-[2px] mt-[7px] opacity-0 group-hover:opacity-100 transition-opacity duration-150">
          <button
